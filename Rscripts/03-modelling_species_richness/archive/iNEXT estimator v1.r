...
# poaceae
  dat.all <- readRDS("Data files/ALA/2019 ALA master data/master grass data.rds") 
...
# save rasters ----------------------------------------------------------------------------
  ...
  n.tot <- ntot[[2]]
  plot(n.tot)  
  writeRaster(n.tot, "Results/Rarefaction/Rasters/iNEXT/Pilot/n.tot.grd", overwrite = T)
  n.c3 <- nc3[[2]]
  plot(n.c3)   
  writeRaster(n.c3, "Results/Rarefaction/Rasters/iNEXT/Pilot/n.c3.grd", overwrite = T)
  n.c4 <- nc4[[2]]
  plot(n.c4) 
  writeRaster(n.c4, "Results/Rarefaction/Rasters/iNEXT/Pilot/n.c4.grd", overwrite = T)
  
  e.tot <- etot[[2]]
  plot(e.tot)  
  writeRaster(e.tot, "Results/Rarefaction/Rasters/iNEXT/Pilot/e.tot.grd", overwrite = T)
  e.c3 <- ec3[[2]]
  plot(n.c3)   
  writeRaster(e.c3, "Results/Rarefaction/Rasters/iNEXT/Pilot/e.c3.grd", overwrite = T)
  e.c4 <- ec4[[2]]
  plot(e.c4) 
  writeRaster(e.c4, "Results/Rarefaction/Rasters/iNEXT/Pilot/e.c4.grd", overwrite = T)
