...
# save raster (we'll make them into a df later)
  writeRaster(est_rich, "C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction/Rasters/Rarefied richness independent/Exotic C3 rich", overwrite = T)
  
# <15 record native C3 cells
  c3_rec <- mask(n_tot, raster)
  plot(log(c3_rec))
  
# save raster                                                                                      
  writeRaster(c3_rec, "C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction/Rasters/Rarefied richness independent/Exotic C3 rec", overwrite = T)
