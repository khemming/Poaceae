...
# update from v6: rarefying C4 and C3 separetely (rather than relative proportions) using the 'solo' rarefaction function (see Rarefaction v5 for original version of equations)
...
# 2. Rarefaction to 15 records solo (not splitting for photosynthetic pathway) ----------------------  
...
writeRaster(est_rich, "C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction/Rasters/Rarefied richness solo/Native C4 rich", overwrite = T)
...
# save raster                                                                                      
writeRaster(C4_rec, "C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction/Rasters/Rarefied richness solo/Native C4 rec", overwrite = T)
