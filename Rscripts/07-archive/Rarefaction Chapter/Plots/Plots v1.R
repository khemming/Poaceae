...
# Model coefficients (Whisker plots) --------------------------------------
...
# Data frame with all photosynthetic classes in it
  c3.coef <- mutate(c3.rich, coef = factor(coef, levels = c("pcoldq", "pwarmq", "mat", "ps", "arid", "pewc", "th", "hii")))
  
  c4.coef <- mutate(c4.rich, coef = factor(coef, levels = c("pcoldq", "pwarmq", "mat", "ps", "arid", "pewc", "th", "hii")))
  
  total.coef <- mutate(total.rich, coef = factor(coef, levels = c("pcoldq", "pwarmq", "mat", "ps", "arid", "pewc", "th", "hii")))
...
# C3 -------------------------------------------------------------------
  h <- ggplot(c3.coef, aes(x = coef, color = status)) +
    theme_classic() +
    scale_color_manual(labels = c("Exotic", "Native"), values = c("blue", "red")) +
    geom_hline(aes(yintercept = 0),
               color = "black", size = 0.6) +
    labs(title = "", x = "Variables", y = "Mean", color = "grey100") +
  ...
  h + theme(axis.text.x = element_text(angle = 45, hjust = 1),
...
# C4 -------------------------------------------------------------------
  i <- ggplot(c4.coef, aes(x = coef, color = status)) +
    theme_classic() +
    scale_color_manual(labels = c("Exotic", "Native"), values = c("blue", "red")) +
    geom_hline(aes(yintercept = 0),
               color = "black", size = 0.6) +
    labs(title = "", x = "Variables", y = "Mean", color = "") +
    geom_point(aes(y = mean), size = 5, position = position_dodge(width = 1)) +
    geom_errorbar(aes(ymin = mean - lower.ci, ymax = mean + upper.ci),
                  size = 1, width = 0, position = position_dodge(width = 1)) +
    annotate("segment", x = -Inf, xend = Inf, y = -Inf, yend = -Inf) +
  ...
  i + theme(axis.text.x = element_text(angle = 45, hjust = 1),
            axis.text.y = element_text(size = 16),
            legend.title = element_blank(),
            legend.text = element_text(size = 16),
            axis.line = element_line(size = 0.5),
...
# Total Nat-Int ------------------------------------
  k <- ggplot(total.coef, aes(x = coef, color = status)) +
    theme_classic() +
    scale_color_manual(labels = c("Exotic", "Native"), values = c("blue", "red")) +
    geom_hline(aes(yintercept = 0),
               color = "black", size = 0.6) +
  ...
  k + theme(axis.text.x = element_text(angle = 45, hjust = 1),
            axis.text.y = element_text(size = 16),
            legend.title = element_blank(),
            legend.text = element_text(size = 16),
            axis.line = element_line(size = 0.5),
