...
# Observed species distributions
  o.n.c3 <- raster("Rasters/Rarefied rasters/r15.n.c3.grd")
  plot(o.n.c3)
  o.n.c3.df <- getValues(o.n.c3)
  
  o.e.c3 <- raster("Rasters/Rarefied rasters/r15.e.c3.grd")
  plot(o.e.c3)
  o.e.c3.df <- getValues(o.e.c3)
  
  o.n.c4 <- raster("Rasters/Rarefied rasters/r15.n.c4.grd")
  plot(o.n.c4)
  o.n.c4.df <- getValues(o.n.c4)
  
  o.e.c4 <- raster("Rasters/Rarefied rasters/r15.e.c4.grd")
  plot(o.e.c4)
  o.e.c4.df <- getValues(o.e.c4)
  
# Predicted species distributions
  p.n.c3 <- raster("Rasters/Predicted distributions/n.c3.predicted.grd")
  plot(p.n.c3)
  p.n.c3.df <- getValues(p.n.c3)
  
  p.e.c3 <- raster("Rasters/Predicted distributions/e.c3.predicted.grd")
  plot(p.e.c3)
  p.e.c3.df <- getValues(p.e.c3)
  
  p.n.c4 <- raster("Rasters/Predicted distributions/n.c4.predicted.grd")
  plot(p.n.c4)
  p.n.c4.df <- getValues(p.n.c4)
  
  p.e.c4 <- raster("Rasters/Predicted distributions/e.c4.predicted.grd")
  plot(p.e.c4)
...
# Interested in how observed native correlates with predicted exotic, but will plot all combinations
  setwd("C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction/Graphs/Scatterplots/Predicted")
...
# not the right method ---------------------------------------------------------
  ...
  # # Total "potential" (pot)
  #   t.e <- raster("Rasters/Rarefied rasters/r15.e.tot.grd")/15
  ...
  #   
  # # C3 potential 
  #   c3.e <- raster("Rasters/Rarefied rasters/r15.e.c3.grd")/15
  ...
  #   
  # # C4 potential 
  #   c4.e <- raster("Rasters/Rarefied rasters/r15.e.c4.grd")/15
...
# native
  ...
  raster <- pot.calc
  legend <- "Standardised \nrichness"
  save <- "Graphs/Predicted distributions/Total poential.jpeg"
...
# native
  ...
  raster <- pot.calc
  legend <- "Standardised \nrichness"
  save <- "Graphs/Predicted distributions/C3 poential.jpeg"
...
# native
  ...
  raster <- pot.calc
  legend <- "Standardised \nrichness"
  save <- "Graphs/Predicted distributions/C4 poential.jpeg"
