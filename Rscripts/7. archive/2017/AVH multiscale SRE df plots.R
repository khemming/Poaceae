...
# changle names
  avh_cor <- select(avh_eda, cell_width, n_a_cor, n_ichao1_cor, n_chao1_cor, n_jack1st_cor, n_jack2nd_cor, n_lanum_cor)
  colnames(avh_cor) <- c("cell_width", "a", "ichao1", "chao1", "jack1st", "jack2nd", "lanum")
  # long data format
  avh_eda_long <- select(avh_cor, cell_width, a, ichao1, chao1, jack1st, jack2nd, lanum)%>%
