...
########################################################
# cleaning step 1: generating native/exotic 'field' codes
########################################################
# date created: 17/5/19
# last updated: 1/7/19
...
# output
  write.csv(dat.final, "ALA/Generated data from cleaning steps/step 1 ALA names & status.csv")
