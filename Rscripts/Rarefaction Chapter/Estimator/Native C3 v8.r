...
# save raster (we'll make them into a df later)
  writeRaster(est_rich, "C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction/Rasters/Rarefied richness independent/Native C3 rich", overwrite = T)
...
# save raster                                                                                      
  writeRaster(c3_rec, "C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction/Rasters/Rarefied richness independent/Native C3 rec", overwrite = T)
