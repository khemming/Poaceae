...
# 2.0 Observed rarefaction 10- to 50- records x Nat/Exo x total/C3/C4 'PROPORTIONs' ------------
# required -----------------------------------------------------------------------------------
# (1) raster
...
# 3. 'independent' raster plots (v8 rarefaction scripts) --------------------------
# required ------------------------------------------------------------------------
# (1) raster
# (2) file save name (e.g. Graphs/Native SR 50-km.jpeg)  
# (3) title: will pop up in the top left hand corner of the plot
...
# data ------------------------------------------------
  setwd("C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction/Rasters/Rarefied richness independent")
...
# save 
  write.csv(ras, "C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction/CSV/Rarefied 15 richness and record number pp independent.csv", row.names = F)
...
# (3) title: will pop up in the top left hand corner of the plot
  ...
  setwd("C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction/Graphs/Rarefied richness independent")
...
# and also between independent rarefaction and porportion C3/C4

# 4.1 Independently porduced C3/C4 by origin ------------------------------  
# run 3. code for rasters
# wd()
  setwd("C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction")
# data --------------------------------------------------------------
  rare.rich <- read.csv("CSV/Rarefied 15 richness and record number pp independent.csv") %>%
    dplyr::select(Native.C3.rich, Native.C4.rich,
                  Exotic.C3.rich, Exotic.C4.rich)
  
  colnames(rare.rich) <- c("n.c3", "n.c4",
                           "e.c3", "e.c4")  
...
# C3-C3
  xlab <- "native C3"
  ylab <- "exotic C3" 
  save <- "Graphs/Scatterplots/Observed independent method/Native C3-exotic C3.jpeg"
...
# C4-C4    
  xlab <- "native C4"
  ylab <- "exotic C4" 
  save <- "Graphs/Scatterplots/Observed independent method/Native C4-exotic C4.jpeg"
...
# 4.2 Proportion of C3/C4 versus independent C3/C4 ----------------------------------
# notes ----------------------------------------------------------------------
# I have tried a new method for partioning C3 and C4 richness
# here I evaluate it against previous method
# previous method dealt with proportion (hence 'prop') and new is sepearate ('independent')    
# -----------------------------------------------------------------------------
# data --------------------------------------------------------------
  setwd("C:/Users/s436862/Dropbox/Rarefaction/Results/Rarefaction")
...
# 5. Independent pp methods model coefficients --------------------------------------
